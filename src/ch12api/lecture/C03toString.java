...
public class C03toString {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(car1.toString());        // toString을 오버라이드
        System.out.println(car2.toString());        // toString을 오버라이드
        System.out.println(car3.toString());        // toString을 오버라이드
    }
}
class Car{
